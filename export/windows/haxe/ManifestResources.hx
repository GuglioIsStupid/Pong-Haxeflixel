...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_sounds_paddlehit_wav extends null { }
...
@:keep @:font("C:/HaxeToolkit/haxe/lib/flixel/5,3,1/assets/fonts/nokiafc22.ttf") @:noCompletion #if display private #end class __ASSET__flixel_fonts_nokiafc22_ttf extends lime.text.Font {}
@:keep @:font("C:/HaxeToolkit/haxe/lib/flixel/5,3,1/assets/fonts/monsterrat.ttf") @:noCompletion #if display private #end class __ASSET__flixel_fonts_monsterrat_ttf extends lime.text.Font {}
