...
HX_LOCAL_STACK_FRAME(_hx_pos_b3b993f62d801895_276___init__,"::ApplicationMain_obj","__init__",0x253d991d,"::ApplicationMain_obj.__init__","ApplicationMain.hx",276,0x0780ded5)
...
void ApplicationMain_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_b3b993f62d801895_276___init__)
HXDLIN( 276)		 ::Dynamic init = ::hx::ClassOf< ::lime::app::Application >();
            	}


void ApplicationMain_obj::main(){
            	HX_STACKFRAME(&_hx_pos_6fcf922b66429816_18_main)
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("FlxProject",a7,cc,16,25),::ApplicationMain_obj::create_dyn());
...
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Pong",18,ac,35,35));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Pong",18,ac,35,35))
...
HXLINE( 109)		 ::openfl::display::Preloader preloader =  ::openfl::display::Preloader_obj::__alloc( HX_CTX , ::flixel::_hx_system::FlxPreloader_obj::__alloc( HX_CTX ,null(),null()));
