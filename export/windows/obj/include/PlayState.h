...
class HXCPP_CLASS_ATTRIBUTES PlayState_obj : public  ::flixel::FlxState_obj
{
	...
	public:
		...
		::String __ToString() const { return HX_("PlayState",5d,83,c2,46); }
		 ...
		 ::flixel::FlxSprite paddle1;
		 ::flixel::FlxSprite paddle2;
		 ::flixel::FlxSprite ball;
		int paddleSpeed;
		int ballSpeed;
		 ::flixel::math::FlxBasePoint ballVelocity;
		Float ballAngle;
		bool ballMoving;
		 ::flixel::sound::FlxSound paddlehit;
		 ::flixel::sound::FlxSound death;
		void create();
